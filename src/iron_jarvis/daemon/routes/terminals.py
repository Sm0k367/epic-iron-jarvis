        ...
        **assist** — one-shot completion; returns reply + optional fenced command
        ...
        if mode == "agent":
            ...
            task = (
                ...
                "IMPORTANT: Your reply is shown in the AI panel ABOVE the shell. "
                "Do NOT invent shell commands for pure chat (hi/hello/thanks). "
                "Just answer in plain text. Never put greetings in a code fence.\n"
                ...
                "Only if the user needs a shell command to run, put EXACTLY ONE "
        ...
        system = (
            ...
            "Your answer appears in the AI chat panel, NOT as PowerShell input. "
            "For greetings or pure Q&A, reply in plain text only — never wrap "
            "chat words like hi/hello in a code fence.\n"
